    ...
    <div className='container mx-auto md:mt-16 mt-7 md:mb-24 mb-16 px-4 md:px-0'>
      <div className='flex justify-center'>
        <div className='md:w-[65%] w-full space-y-10'>
          <div>
            <h1 className='text-main text-[50px] font-bold'>About QuizAI</h1>
          ...
          <div>
            <h1 className='text-main text-heading font-bold capitalize'>Our Mission</h1>
          ...
          <div>
            <h1 className='text-main text-heading font-bold capitalize'>Why We Built QuizAI</h1>
          ...
          {/* our values */}
          <div>
            <h1 className='text-main text-heading font-bold capitalize mb-2'>Our Values</h1>
