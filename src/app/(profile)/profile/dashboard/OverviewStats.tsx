  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
      <div className='bg-card border border-gray-700/50 rounded-lg p-6'>
        ...
        <p className='text-sm font-medium text-title'>{stats?.quizzes_change > 0 ? `+${stats?.quizzes_change}` : stats?.quizzes_change} from last week</p>
      </div>
      ...
      <div className='bg-card border border-gray-700/50 rounded-lg p-6'>
        ...
        <p className='text-sm font-medium text-title'>{stats?.submissions_change > 0 ? `+${stats?.submissions_change}` : stats?.submissions_change} from last week</p>
      </div>
      ...
      <div className='bg-card border border-gray-700/50 rounded-lg p-6'>
        ...
        <p className='text-sm font-medium text-title'>{stats?.score_change > 0 ? `+${stats?.score_change}` : stats?.score_change} from last week</p>
      </div>
    </div>
  )
}
