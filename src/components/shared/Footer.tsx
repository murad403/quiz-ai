...
const Footer = () => {
    return (
        <footer className='bg-white/10 pt-10 border-t border-gray-700/70 mt-32'>
            <div className='mx-auto container'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-between gap-4 border-b border-gray-700/70 pb-10'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Link className='text-title hover:text-main text-small' href={"#features"}>Pricing</Link>
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h2 className='text-main font-semibold text-subheading'>Company</h2>
                        <Link className='text-title hover:text-main text-small' href={"#features"}>About</Link>
                        <Link className='text-title hover:text-main text-small' href={"#features"}>FAQ</Link>
                        <Link className='text-title hover:text-main text-small' href={"#features"}>Contact</Link>
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h2 className='text-main font-semibold text-subheading'>Legal</h2>
                        <Link className='text-title hover:text-main text-small' href={"#features"}>Privacy Policy</Link>
                        <Link className='text-title hover:text-main text-small' href={"#features"}>Terms of Service</Link>
                    </div>
                </div>
